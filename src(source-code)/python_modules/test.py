# -*- coding: utf-8 -*-
"""
Created on Mon Sep 28 13:57:55 2020
...
root = Tk()
root.filename =  filedialog.askopenfilename(title = "choose your go term type dataset",filetypes = (("excel files","*.xlsx"),("all files","*.*")))
...
data_to_merge_with_fitness_data=datawithinteractions
data_fitness_sga=datawithfitness
data_raw_slim_go=datawithgoterms


gene_name='BEM1'
filtered_genes=data_to_merge_with_fitness_data[data_to_merge_with_fitness_data['Gene']==gene_name]['Interactor'].tolist()
filtered_genes=np.unique(filtered_genes)
filtered_gene_name=data_to_merge_with_fitness_data[data_to_merge_with_fitness_data['Gene']==gene_name]
